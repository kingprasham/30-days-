...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            setFlashMessage('success', 'Dealer added successfully');
    ...
    <div class="col-lg-10">
        <div class="card">
            <div class="card-header">
                <i class="fas fa-handshake me-2"></i>Add New Dealer
            </div>
            <div class="card-body">
                <?php if (!empty($errors)): ?>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="state_id" class="form-select select2">
                                ...
                                <option value="<?= $state['id'] ?>" <?= ($_POST['state_id'] ?? '') == $state['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="territory" class="form-select">
                                ...
                                <option value="<?= $t ?>" <?= ($_POST['territory'] ?? '') === $t ? 'selected' : '' ?>>
                                    <?= $t ?>
                                </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="service_location" class="form-control"
                                   value="<?= htmlspecialchars($_POST['service_location'] ?? '') ?>">
                        </div>
                    </div>
